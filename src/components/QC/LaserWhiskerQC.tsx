...
export default function LaserWhiskerQC() {
                        ...
                        if(batchCheckId){
                          getData<BatchStageHistory[]>(
                            ...
                            (historyData: BatchStageHistory[]) => {
                              const brushStage = historyData.find(stage => stage.stage === "Laser Whisker");
                              if(brushStage?.closed_by!=null){
                                  setRejectError("This piece cannot be rejected as Laser Whisker stage is already closed for this batch.");
                                  setRejectPop(false);
                                  setReason("");
                                  setReasonDisplay("");
                                  return
