...
export default function LaserBrushQC() {
                          ...
                          if(batchCheckId){
                            getData<BatchStageHistory[]>(
                              ...
                              (historyData: BatchStageHistory[]) => {
                                const brushStage = historyData.find(stage => stage.stage === "Laser Brush");
                                if(brushStage?.closed_by!=null){
                                    setRejectError("This piece cannot be rejected as Laser Brush stage is already closed for this batch.");
                                    setRejectPop(false);
                                    setReason("");
                                    setReasonDisplay("");
                                    return
