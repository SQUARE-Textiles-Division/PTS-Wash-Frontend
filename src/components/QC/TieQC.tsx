                          ...
                          if(batchCheckId){
                            getData<BatchStageHistory[]>(
                              ...
                              (historyData: BatchStageHistory[]) => {
                                const brushStage = historyData.find(stage => stage.stage === "Tie");
                                if(brushStage?.closed_by!=null){
                                    setRejectError("This piece cannot be rejected as Tie stage is already closed for this batch.");
                                    setRejectPop(false);
                                    setReason("");
                                    setReasonDisplay("");
                                    return
