...
export default function WhiskerQC() {
                          ...
                          if(batchCheckId){
                            getData<BatchStageHistory[]>(
                              ...
                              (historyData: BatchStageHistory[]) => {
                                const brushStage = historyData.find(stage => stage.stage === "Whisker");
                                if(brushStage?.closed_by!=null){
                                    setRejectError("This piece cannot be rejected as Whisker stage is already closed for this batch.");
                                    setRejectPop(false);
                                    setReason("");
                                    setReasonDisplay("");
                                    return
