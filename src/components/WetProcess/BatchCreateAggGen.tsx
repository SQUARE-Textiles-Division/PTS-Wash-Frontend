...
import { useApiService } from "../genericApiService";
    ...
    export default function BatchCreateAgg({stage}:WetProcessStage){
        ...
        <TableContainer
            ...
            // left: 0,
            right: 0,
            maxHeight: 450,          // vertical scrollbar
        ...
        <Button variant="contained"  onClick={handleCreateBatch} sx={{ position:'fixed',top:550,background:tbCellColor}}>Create Batch</Button>
