...
export default function UnloadFinish({stage}:WetProcessStage) {    
    const {getData,patchData}=useApiService()
...
//    console.log(machineList)
    const fetchData = (batchcode: string )=> {
        ...
        const batchIdNum = batchcode; // Extract numeric part and convert to number
